...
ggsave(file="hetall.pdf", width=150, height=150, units=c("mm"),useDingbats=FALSE)
...
het.pc2.plot <- ggplot(het.mums.df,aes(x=het,y=PC2)) +
        ...
        xlab("sMLH") +
        ylab("PC2 score") 
ggsave(file="hetpc.pdf", width=150, height=150, units=c("mm"),useDingbats=FALSE)
...
pc.dens.plot.1 <- ggplot(pca.scores,aes(x=PC1)) +
        ...
        xlab("PC1 score") +
        ylab("Density")
ggsave(file="PC Scores 1.pdf", width=150, height=150, units=c("mm"),useDingbats=FALSE)
...
ggsave(file="PC Scores 2.pdf", width=150, height=150, units=c("mm"),useDingbats=FALSE)
